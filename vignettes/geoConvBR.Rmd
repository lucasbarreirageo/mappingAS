---
title: "geoConvBR: triagem do Critério B (EOO, AOO e conversão MapBiomas)"
author: "geoConvBR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{geoConvBR: triagem do Critério B (EOO, AOO e conversão MapBiomas)}
...
`geoConvBR` é uma ferramenta no estilo do [GeoCat](https://geocat.iucnredlist.org/)
...
ts <- timeseries_for_species(res, range = "eoo", by = "class")
